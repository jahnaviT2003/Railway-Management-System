           ...
           HttpSession session=request.getSession(false);
            ...
            String train_name=request.getParameter("train_name");
               ...
               String fare=request.getParameter("fare");
                try{
                    PreparedStatement psmt=con.prepareStatement("SELECT TRAIN_NAME,SEAT_AVAIL,FARE FROM TRAIN WHERE TRAIN_ID="+train_id+",SOURCE="+source+",DESTINATION="+destination+",TRAIN_DATE="+train_date+"");
                    psmt.setString(1, train_name);
                            psmt.setString(2, seat_avail);
                    psmt.setString(3, fare);
